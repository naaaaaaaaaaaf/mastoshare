export const handleAddNewInstance = async (newMastodonInstance, instancesList, setInstancesList, setAddInstanceError) => {
    try {
        const response = await fetch(`https://${newMastodonInstance}/api/v1/instance`);
